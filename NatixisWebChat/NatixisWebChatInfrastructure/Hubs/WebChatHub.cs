namespace NatixisWebChatInfrastructure.Hubs
{
    using Microsoft.AspNetCore.Authorization;
    using Microsoft.AspNetCore.SignalR;
    using NatixisWebChatDomain.AppHubs;
    using NatixisWebChatInfrastructure.Hubs.Dictionaries;

    [Authorize]
    public class WebChatHub : Hub
    {
        public static List<UserHub> connectedUsers = new List<UserHub>();
        private static MessageDictionaryHub _messageDictionary = new MessageDictionaryHub();
        private static GroupDictionaryHub _groupDictionary = new GroupDictionaryHub();
        ...
        public async Task SendPrivateMessage(string toUser, string message)
        {
            ...
            var saveMessage = new MessageHub()
            {
